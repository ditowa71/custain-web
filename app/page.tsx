      ...
      <div className="wrap">
        ...
        <div className="cards">
          ...
          <article className="card">
            ...
            <div className="spacer" />
            <div className="ambit">
              <div className="meta">Aktuelles Produkt: <strong>Karriva</strong> — KI-Karrierecoach</div>
              <a className="link" href="https://karriva.com" target="_blank" rel="noopener noreferrer">
                karriva.com <span className="arrow">→</span>
              </a>
            </div>
          </article>
        </div>
      ...
      <div className="wrap">
        ...
        <div className="about-grid">
          ...
          <div className="about-body">
            ...
            <p>
              Ein konstanter Schwerpunkt seiner Arbeit: der Aufbau und die Weiterentwicklung von Kundenbindungsprogrammen, die tatsächlich funktionieren. Parallel dazu entsteht mit <a href="https://karriva.com" target="_blank" rel="noopener noreferrer" className="text-link">Karriva</a> ein erstes eigenes KI-Produkt: ein Karrierecoach, der Bewerbern hilft, ihre Stärken klar zu formulieren und gezielt einzusetzen.
            </p>
